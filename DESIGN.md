...
Resumatrix presents one developer profile through seven deliberately different interfaces. The content should remain consistent while each view demonstrates a different design vocabulary:
