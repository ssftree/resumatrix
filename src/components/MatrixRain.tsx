...
export const MatrixRain: React.FC<MatrixRainProps> = ({ active, color = '#22c55e', onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black/90 pointer-events-auto flex flex-col items-center justify-center">
      ...
      <div className="relative z-50 text-center px-4 py-3 bg-black/80 border border-emerald-500/50 rounded-lg shadow-2xl backdrop-blur-md max-w-sm mx-auto">
        ...
        <p className="text-xs text-neutral-400 mb-3">Press any key, click below, or type 'matrix' to toggle off</p>
        <button
          onClick={onClose}
